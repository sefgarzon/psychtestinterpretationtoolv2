const WPC_DATA = {
    ...
    bpi: {
        hypochondriasis: { low: "he has no excessive concern with regards to physical health, thus absenteeism due to illness is negligible.", high: "he experiences significant anxiety related to physical health." },
        depression: { low: "he feels confident, cheerful and persistent despite disappointments; has an optimistic attitude about the future.", high: "is inclined to be down-hearted and show extreme despondency; considers self to be inadequate; may be listless, remote, and preoccupied; looks at the future pessimistically." },
        anxiety: { low: "he remains calm, unruffled and not worried even when confronted by unexpected occurrences; takes things as they come without fear or apprehension; maintains personal control even in crisis situations.", high: "he is easily scared and worrisome; little things, even an idea, can cause a frenzy of anxiety; afraid of physical or interpersonal danger." },
        interpersonal: { low: "he usually cooperates in activities which involves others, friendly and can be relied on; is not easily affected by environmental disturbances, has the facility of handling changes in routine, disappointments, others’ mistakes and authority.", high: "he is often extremely annoyed by little inconveniences, frustrations, or disappointments; uncooperative, disobedient, resistant to others, and reacts against discipline, rules and criticism." },
        alienation: { low: "he ordinarily displays socially acceptable ethical attitudes and responsibility; reports a sense of obligation to society and its laws.", high: "he expresses attitudes markedly different from common social codes; is prone to depart from the truth and behave in an unethical/illegal and untrustworthy manner; feels little or no guilt about behavior." },
        impulse: { low: "he is cautious and level headed when making choices. has the determination to adjust to complex tasks.", high: "he lacks the ability to think beyond the present and to consider the consequences of action; prone to undertake risky and reckless actions; inclined to behave irresponsibly; finds routine tasks boring." },
        persecutory: { low: "he accepts responsibility for whatever happens to him and does not attribute malice to others. He is not threatened by the presence of other people around him/her.", high: "he believes that certain people are hostile and are trying to make life difficult and/or unpleasant; inclined to brood; distrusts others." },
        thinking: { low: "he does not show confusion, distractibility or cognitive disorganization in a significant proportion; his ability to distinguish what is real from what is not is relatively excellent.", high: "he is markedly confused, distractible and cognitively disorganized; cannot remember simple things from day to day; reports feeling that life is dream-like, and that there is a marked difference between self and others." },
        introversion: { low: "he initiates conversation with others, is socially responsive and feels comfortable in having many friends.", high: "he avoids people generally; has few friends, or is withdrawing from friends; says little to others, even friends; seems to be uncomfortable when around others; prefers to keep to self or asocial activities." },
        selfDepreciation: { low: "he shows confidence of what he is and what he can do as a person; does not degrade himself to be worthless, unpleasant or undeserving.", high: "he degrades self as being worthless, unpleasant, and undeserving; generally, expresses a low opinion of self and refuses credit for any accomplishment." },
        deviation: { low: "he shows behaviors patterns that are similar to most people and is free from unusual symptoms and ways of thinking.", high: "he displays behavior patterns very different from most people; admits to unusual and pathological characteristics." },
        denial: { low: "he does not show defensiveness in dealing with his feelings and behavior trying to decipher what they mean rather than avoid them.", high: "is fairly defensive, may deny normal affective responses and tends to repress unpleasant or emotionally charged conditions- deals with stress through active flight or avoidance." }
    },
    eq: {
        intrapersonal: {
